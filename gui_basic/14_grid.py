...
btn_enter.grid(row=4, column=3, rowspan=2, sticky=N+E+W+S) # 현재 위치로부터 아래쪽으로 몇 줄을 더함.

# 0 시작 줄
btn_0 = Button(root, text="0", padx=10, pady=10)
btn_point = Button(root, text=".", padx=10, pady=10)

btn_0.grid(row=5, column=0, columnspan=2, sticky=N+E+W+S) # 현재 위치로부터 오른쪽으로 몇 칸 더함.
